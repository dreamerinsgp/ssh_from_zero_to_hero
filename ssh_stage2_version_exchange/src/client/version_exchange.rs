...
pub fn perform_version_exchange(mut stream: TcpStream, username: &str) -> Result<(VersionString, VersionString)> {
    ...
    let client_version = VersionString::new("2.0", "ssh_stage2_version_exchange", Some(username));
